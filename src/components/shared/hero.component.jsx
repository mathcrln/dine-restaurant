...
const Hero = ({
	...
	return (
		<section
			className={`laptop:pt-16 bg-codGray text-white bg-no-repeat bg-cover laptop:bg-center bg-${page}-hero-mobile laptop:bg-${page}-hero-desktop tablet:bg-${page}-hero-tablet ${classProperties}`}
		>
			<Container>
				<Header />
				<div>
